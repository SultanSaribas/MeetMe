...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt.setText("History Meetings");


        eventList = new ArrayList<>();

        eventReference = FirebaseDatabase.getInstance("https://meetme-2ff9d-default-rtdb.firebaseio.com/").getReference("Categories").child("History");
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.nav_search:
                        intent = new Intent(HistoryActivity.this, DiscoverActivity.class);
                        startActivity(intent);
                        break;
