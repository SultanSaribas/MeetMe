...
public class SportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt.setText("Sport Meetings");


        eventList = new ArrayList<>();

        eventReference = FirebaseDatabase.getInstance("https://meetme-2ff9d-default-rtdb.firebaseio.com/").getReference("Categories").child("Sport");
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.nav_search:
                        intent = new Intent(SportActivity.this, DiscoverActivity.class);
                        startActivity(intent);
                        break;
                    case R.id.nav_profile:
                        intent = new Intent(SportActivity.this, ProfileActivity.class);
                        startActivity(intent);
                        break;
                }
                return false;
